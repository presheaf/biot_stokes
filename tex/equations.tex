...
\newcommand{\matzero}{}        %can't decide if matrix looks readable without 0-entries written in 
...
\[ \renewcommand{\arraystretch}{1.8}
  \left[\begin{array}{@{}ccc|cc|c@{}}
          ...
          \matzero & \alpha B^{\disptest}_p & A^e_p & - S_{\disptest, \uf} & \matzero & N^p_{\disptest, \mult}\\ % \disptest -row
          \hline
          \matzero & \matzero & - \frac 1 {\dt} S_{\vf, \disp} & A_f & B_f & N^f_{\vf, \mult}\\ % \vf -row
...
\[ \renewcommand{\arraystretch}{1.8}
  \left[\begin{array}{@{}ccc|cc|c@{}}
          ...
          A^d_p & B^{\vp}_p & \matzero & \matzero & \matzero & N^p_{\vp, \mult} \\ % \vp -row
          (B^{\vp}_p)^T & -\frac {s_0}{\dt} M_{\pp} & \frac{\alpha}{\dt} (B^{\disptest}_p)^T & \matzero & \matzero & \matzero\\ % \wp -row 
          \matzero & \frac {\alpha} {\dt} B^{\disptest}_p & \frac 1 {\dt}A^e_p & -\frac 1 {\dt} S_{\disptest, \uf} & \matzero &\frac 1 {\dt} N^p_{\disptest, \mult}\\ % \disptest -row
          \hline
          \matzero & \matzero & - \frac 1 {\dt} S_{\vf, \disp} & A_f & B_f & N^f_{\vf, \mult}\\ % \vf -row
          \matzero & \matzero & \matzero & B_f^T & \matzero & \matzero \\ % \wf -row
          \hline
